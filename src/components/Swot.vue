    ...
    <div class="text-h4">Strengths, Weaknesses, Opportinities and Threats</div>
      <div class="row q-gutter-md">
        <div class="col q-pa-md">
          ...
          <q-editor v-model="swot.strengths_html" min-height="5rem" />
        </div>
        <div class="col q-pa-md">
          ...
          <q-editor v-model="swot.weaknesses_html" min-height="5rem" />
        </div>
      </div>
      <div class="row q-gutter-md">
        <div class="col q-pa-md">
          ...
          <q-editor v-model="swot.opportunities_html" min-height="5rem" />
        </div>
        <div class="col q-pa-md">
          ...
          <q-editor v-model="swot.threats_html" min-height="5rem" />
        </div>
      </div>
